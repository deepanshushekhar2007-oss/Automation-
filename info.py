    ...
    if chat_type in ["group", "supergroup"]:
        ...
        try:
            ...
            # /tg
                ...
                if not args:
                    sent = await message.answer("Usage: /tg <user_id or @username>")
                else:
                    try:
                        # username support
                        if args.startswith("@"):
                        ...
                        sent = await message.answer("❌ Invalid username or ID!")
    ...
    try:
        if mode == "number":
            ...
            try:
                ...
                await message.answer("❌ Invalid username or ID!")
